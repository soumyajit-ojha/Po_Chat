"""
Django settings for pochat project.
This file contains all the configuration serrings for this Django project.
"""
...
if DEBUG is True:
    EMAIL_BACKEND = (
        "django.core.mail.backends.console.EmailBackend"  # Only for development.
    )
ALLOWED_HOSTS = []
...
INSTALLED_APPS = [
    # rule daphne should have to first to avoid conflic of commanding runserver command.
    "daphne",
    "personal",
    "account",
    "friend",
